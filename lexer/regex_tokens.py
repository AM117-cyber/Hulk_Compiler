from lexer.hulk_token_types import *

operators = [
    (TokenType.OPEN_CURLY, "{"), (TokenType.CLOSE_CURLY, "}"), (TokenType.SEMICOLON, ";"),
    (TokenType.OPEN_PAREN, "\\("), (TokenType.CLOSE_PAREN, "\\)"), (TokenType.ARROW, "=>"), (TokenType.COMMA, ","),
    (TokenType.ASSIGNMENT, "="), (TokenType.DEST_ASSIGNMENT, ":="),
    (TokenType.PLUS, "+"), (TokenType.MINUS, "-"), (TokenType.STAR, "\\*"), (TokenType.DIV, "/"),
    (TokenType.POWER, "^"), (TokenType.MOD, "%"), (TokenType.DOUBLE_STAR, "\\*\\*"),
...
reserved_words = [
    ...
    (TokenType.BOOLEAN, "true|false"), (TokenType.PI, "PI"), (TokenType.EULER, "E")]
