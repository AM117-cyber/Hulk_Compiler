...
class Method:
    ...
    #changed
    def set_return_type(self,typex):
        self.return_type = typex
...
class Type:
    ...
    def conforms_to(self, other):
        ...
        if isinstance(other,Type):
            ...
            return all(self_method.method.value.implements_method(other_method.value) for self_method, other_method in zip(self.methods,other.methods))
